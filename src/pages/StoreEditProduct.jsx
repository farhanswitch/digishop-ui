  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setImagePreview(`http://localhost:4777/file/${product.imagePath}`);
      })
      .catch(() => {
        setResponse({
          statusMsg: "error",
  ...
  const handleSubmit = (e) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setResponse({
          statusMsg: "success",
          msgDetails: "Product updated successfully.",
        });
      ...
      .catch((err) => {
        if (err.response?.status === 401) {
          ...
          setResponse({
            statusMsg: "error",
            msgDetails:
              err.response?.data?.msgDetails || "Failed to update product.",
          });
        }
      })
      .finally(() => {
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-5xl mx-auto mt-10 bg-white p-6 rounded-xl shadow-md">
          <div className="flex items-center mb-6">
            ...
            <h1 className="text-xl font-bold text-[#422D23]">Edit Product</h1>
          </div>
