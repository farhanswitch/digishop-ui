          ...
          <div className="w-full max-w-5xl px-4">
            <div className="bg-white px-8 py-6 rounded-2xl shadow-xl w-full max-w-2xl mx-auto">
              <div className="flex items-center mb-6">
                ...
                <h1 className="text-xl font-bold text-[#422D23]">Register</h1>
              </div>
              <form
                onSubmit={(e) => {
                  e.preventDefault();
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-xl transition-colors mt-2"
                >
                  Register
                </button>
              </form>
